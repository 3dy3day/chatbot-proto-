...
def main():
    ...
    # model=ConvAIModel("rinna/japanese-gpt2-medium", args=train_args)
    # model=ConvAIModel("rinna/japanese-roberta-base", args=train_args)

    model.train_model("pre_data.json")
    model.interact()
